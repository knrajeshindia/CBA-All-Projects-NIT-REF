...
public interface AccountTransactionsDAO {
	 ...
	 */
	public  abstract AccountTransactions getAccountTransactionsDetails(String accountTransactionId);

	public abstract int updateAccountTransactionDetails(AccountTransactions accountTransactions);

	public  abstract int saveAccountTransactionDetails(AccountTransactions accountTransactions);
}
